        ...
        <tbody>
          <tr v-for="post in posts">
            ...
            <td class="bg-white border-b border-gray-200 text-left p-2 flex">
              ...
              <div class="">
                <svg @click="deletePost(post)" class="size-4 text-red-600 cursor-pointer" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
